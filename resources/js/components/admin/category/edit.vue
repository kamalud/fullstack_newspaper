        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <router-link :to="{name:'category-list'}" class="btn btn-primary float-right"><i class="fa fa-list"> List</i></router-link>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
export default {
  ...
  methods: {
      categoryInfo:function(){
        this.form.post('/admin/category-update').then(response=>{
      ...
      getCategory:function(){
        let this_ = this;
         axios.get("/admin/category-edit/" + this.$route.params.slug).then(response=>{
